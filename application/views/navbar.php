    ...
    <div class="navbar-header pull-left">
      <a href="<?php echo site_url()?>" class="navbar-brand">
        <small>
          ...
          TEKAJE|
          <img src="<?php echo base_url()?>/assets/images/avatars/logoSMK.png" width="20">
        </small>
      </a>
    </div>
      ...
      -->
        ...
        <li class="light-blue dropdown-modal">
          <a data-toggle="dropdown" href="#" class="dropdown-toggle">
            <img class="nav-user-photo" src="<?php echo base_url()?>assets/images/avatars/logoSMK.png" alt="Astrindo's Photo" />
            <span class="user-info">
              <small>Welcome,</small>
              <?php echo $this->session->userdata('username-abs')?>
            </span>
